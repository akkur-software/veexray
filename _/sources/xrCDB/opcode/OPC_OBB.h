...
public:
	...
	//! Constructor
	inline OBB(const icePoint& center, const icePoint& extents, const Matrix3x3& rot) : mCenter(center), mExtents(extents),
	                                                                               mRot2(rot)
	{
	}
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
FUNCTION bool ComputeSpread(const IndexedTriangle* tris, udword nbtris, const icePoint* verts,
                                            udword nbverts, icePoint& center, icePoint& eigenvalues, Matrix3x3& eigenvectors,
                                            bool usehull = false);
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
FUNCTION bool ComputeOBB(const IndexedTriangle* tris, udword nbtris, const icePoint* verts, udword nbverts,
                                         OBB& obb, bool usehull);

FUNCTION void OBBFromTriangle(const icePoint& p1, const icePoint& p2, const icePoint& p3, OBB& obb);
