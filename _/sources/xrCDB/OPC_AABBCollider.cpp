 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
inline bool AABBCollider::AABBContainsBox(const icePoint& bc, const icePoint& be)
{
...
void AABBCollider::_Collide(const AABBCollisionNode* node)
{
	...
	if (AABBContainsBox(node->mAABB.mCenter, node->mAABB.mExtents))
	{
		mFlags |= OPC_CONTACT; _Dump(node); return;
	}
...
void AABBCollider::_Collide(const AABBQuantizedNode* node)
{
	...
	const icePoint Center(float(Box->mCenter[0]) * mCenterCoeff.x, float(Box->mCenter[1]) * mCenterCoeff.y,
	                   float(Box->mCenter[2]) * mCenterCoeff.z);
	const icePoint Extents(float(Box->mExtents[0]) * mExtentsCoeff.x, float(Box->mExtents[1]) * mExtentsCoeff.y,
