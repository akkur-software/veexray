...
public:
	...
	// Stats
	inline void SetCount(udword nb) { mCount = nb; }
	inline void IncreaseCount(udword nb) { mCount += nb; }
	inline udword GetCount() const { return mCount; }
	inline void SetNbInvalidSplits(udword nb) { mNbInvalidSplits = nb; }
	inline void IncreaseNbInvalidSplits() { mNbInvalidSplits++; }
	inline udword GetNbInvalidSplits() const { return mNbInvalidSplits; }
...
public:
	...
	virtual bool ComputeGlobalBox(const udword* primitives, udword nb_prims, AABB& global_box) const;
	virtual float GetSplittingValue(udword index, udword axis) const;
	virtual float GetSplittingValue(const udword* primitives, udword nb_prims, const AABB& global_box,
	                                                  udword axis) const;

	const IndexedTriangle* mTriList; //!< Shortcut to an app-controlled list of triangles.
	const icePoint* mVerts; //!< Shortcut to an app-controlled list of vertices.
