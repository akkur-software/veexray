 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Matrix4x4& Matrix4x4::Shadow(const icePoint& light, const icePoint& p0, const icePoint& p1, const icePoint& p2)
{
	// The 3 input vertices form the projection plane.

	// Compute the plane equation
	icePoint n = ((p0 - p1) ^ (p1 - p2)).Normalize();
	float D = -(p0 | n);
	Plane PlaneEquation;
	float Coeff;
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Matrix4x4& Matrix4x4::SelfShadow(const icePoint& light)
{
	icePoint Light = light;
	Light.Normalize();
...
Matrix4x4& Matrix4x4::Rot(float angle, icePoint& p1, icePoint& p2)
{
	icePoint Axis = (p2 - p1).Normalize();
	...
	if (d != 0.0f)
	{
		...
		Rx.SetRow(1, icePoint(0.0f, CosAngle, SinAngle));
		Rx.SetRow(2, icePoint(0.0f, -SinAngle, CosAngle));
	}
	InvRx = Rx;
	InvRx.Invert();
	...
	Matrix4x4 Ry, InvRy;
	Ry.Identity();
	Ry.SetRow(0, icePoint(d, 0.0f, Axis.x));
	Ry.SetRow(2, icePoint(-Axis.x, 0.0f, d));
	InvRy = Ry;
	InvRy.Invert();
...
Matrix& Matrix::ComputeAxisMatrix(icePoint& axis, float angle)
{
	MakeIdentity();
	...
	float dotProduct = icePoint(0, 1, 0) | axis;
	icePoint Up = icePoint(0, 1, 0) - dotProduct * axis;
...
Matrix::operator	PRS() const
{
	...
	float		ScaleFactor;
	icePoint		Scale, Row, NormalizedRow;
