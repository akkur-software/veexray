...
{
public:
	AABBTreeNode(); ~AABBTreeNode(); inline const AABB* GetAABB() const
	{
		return &mBV;
	} 
	...
	inline udword GetNodeSize() const
	{
		return sizeof(*this);
	} 
protected: 
...
public:
	// Data access
	inline const udword* GetPrimitives() const { return mNodePrimitives; }
	inline udword GetNbPrimitives() const { return mNbPrimitives; }
...
public:
	...
	// Data access
	inline const udword* GetIndices() const { return mIndices; } //!< Catch the indices
	inline udword GetNbNodes() const { return mTotalNbNodes; } //!< Catch the number of nodes
